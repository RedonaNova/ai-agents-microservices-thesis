...
\begin{itemize}
    \item Олон агентын архитектур: Зохион байгуулагч, хөрөнгө оруулалтын, мэдээний, мэдлэгийн, төлөвлөгч гэсэн таван агент
    \item Хувийн зөвлөмж: Хэрэглэгчийн профайл (эрсдэлийн хүлээцтэй байдал, хөрөнгө оруулалтын зорилго) дээр суурилсан шинжилгээ
    \item Монгол хэлний дэмжлэг: Бүх хиймэл оюуны хариултууд монгол хэлээр
    \item Бодит өгөгдөл: МХБ-ийн 2015-2024 онд явагдсан арилжааны түүхэн мэдээлэл
\end{itemize}
...
Зураг \ref{fig:implemented-architecture}-т демо системийн архитектурын зохиомжийг дүрсэлсэн. Системийн гол бүрэлдэхүүнүүдийг дараах дарааллаар тайлбарлана.

\subsection{Frontend давхарга}

Next.js 16 фреймворк ашиглан React дээр суурилсан хэрэглэгчийн интерфейс хөгжүүлсэн. TypeScript хэл ашигласан нь хэрэглэгчийн кодын аюулгүй байдлыг хангаж, Tailwind CSS болон Shadcn/UI компонентууд ашигласан нь хурдан, уян хатан дизайн хийх боломжийг олгосон. TradingView виджетүүд ашиглан МХБ-аас гадна олон улсын хувьцаануудын график харуулна.
...
Гол endpoints:
\begin{itemize}
    \item \texttt{POST /api/agent/query} - Хэрэглэгчийн асуултыг хүлээн авч, төлөвлөгч агент руу илгээх
    ...
    \item \texttt{POST /api/agent/analyze-watchlist} - Хэрэглэгч өөрийн сонирхсон МХБ-ийн хувьцаануудын шинжилгээг авах
\end{itemize}
...
\subsection{Төлөвлөгч агент (Orchestrator Agent)}
...
\textbf{Гол үүргүүд:}
\begin{enumerate}
    \item Intent Classification: Google Gemini 2.5 Flash ашиглан хэрэглэгчийн асуултыг portfolio, market\_analysis, news, risk\_assessment, historical\_analysis, general\_query гэсэн ангилалд хуваана
    \item Complexity Detection: Асуулт энгийн эсвэл олон агент шаардсан нарийн төвөгтэй эсэхийг тодорхойлно
    \item User Profile Fetching: PostgreSQL-ээс хэрэглэгчийн investment\_goal, risk\_tolerance, preferred\_industries мэдээллийг авч, хувийн зөвлөмж өгөхөд ашиглана
    \item RAG Context Request: Шаардлагатай бол мэдлэгийн агент руу хүсэлт илгээж, нэмэлт контекст авна
    \item Routing: Энгийн асуултыг шууд agent.tasks руу, нарийн төвөгтэй асуултыг planning.tasks руу илгээнэ
\end{enumerate}

\textbf{Процессийн урсгал (Код \ref{code:orchestrator}):}
...
\textbf{Kafka topics:}
\begin{itemize}
    \item Subscribe: user.requests, knowledge.results
    \item Publish: agent.tasks, planning.tasks, knowledge.queries, monitoring.events
\end{itemize}
...
\textbf{Гол үүргүүд:}
\begin{enumerate}
    \item МХБ өгөгдөл татах: PostgreSQL-ээс mse\_trading\_status (сүүлийн үнэ) болон mse\_trading\_history (түүхэн өгөгдөл) хүснэгтээс мэдээлэл авна
    \item Хувийн зөвлөмж үүсгэх: Хэрэглэгчийн investmentGoal, riskTolerance, preferredIndustries мэдээлэлд суурилан AI промпт бэлдэнэ
    \item Монгол хариулт үүсгэх: Gemini 2.5 Flash ашиглан монгол хэл дээр товч, мэргэжлийн хариулт үүсгэнэ
    \item Хариулт хадгалах: agent\_responses\_cache хүснэгтэд хариултыг хадгалж, дараа нь polling хийхэд ашиглана
\end{enumerate}
...
\begin{itemize}
    ...
    \item \texttt{analyze\_watchlist} - Өөрийн сонирхсон хувьцаануудын шинжилгээ
\end{itemize}

\textbf{Хувийн зөвлөмжийн логик (Код \ref{code:personalization}):}

Хэрэглэгчийн профайлаас контекст бүрдүүлж, Gemini AI руу промпт илгээнэ. Эрсдэлийн хүлээцтэй байдал "Low" бол аюулгүй хувьцаа, "High" бол өндөр өсөлттэй хувьцаа санал болгоно.
...
\textbf{Гол үүргүүд:}
\begin{enumerate}
    \item Өгөгдлийн сан: PostgreSQL-ийн knowledge\_base хүснэгтээс компанийн профайл, бизнес дүрэм, агентуудын чадварын мэдээллийг ачаална
    \item Утга зүйн хайлт: Түлхүүр үгийн тохирол болон metadata фильтер ашиглан хамгийн холбогдолтой баримтуудыг олно
    \item Контекст дамжуулах: Олдсон баримтуудыг knowledge.results сэдвээр буцаана
\end{enumerate}

\textbf{Өгөгдлийн сангийн мэдээллүүд:}
\begin{itemize}
    \item МХБ компаниудын профайл (APU, TDB гэх мэт)
    \item Арилжааны дүрэм (арилжааны цаг, хязгаарлалт)
    \item Эрсдэлийн менежментийн зөвлөмж
    \item Агент бүрийн чадварын тайлбар (төлөвлөгч агентад туслах)
\end{itemize}
...
\textbf{Гол үүргүүд:}
\begin{enumerate}
    \item Гүйцэтгэлийн төлөвлөгөө үүсгэх: Gemini AI эсвэл дүрэмд суурилсан логик ашиглан олон алхамт төлөвлөгөө боловсруулна
    \item Агентуудад даалгавар хуваарилах: Төлөвлөгөөний алхам бүрийг тохирох агент руу agent.tasks сэдвээр илгээнэ
    \item Параллель гүйцэтгэл: Хамааралгүй алхмуудыг зэрэг гүйцэтгэх боломжийг олгоно
\end{enumerate}
...
\hline
\endfirsthead
user.requests & Хэрэглэгчийн асуултууд API Gateway-ээс төлөвлөгч агент руу \\
\hline
...
\hline
mse\_trading\_status & Сүүлийн арилжааны үнэ, хэмжээ \\
\hline
...
\begin{itemize}
    ...
    \item Эрсдэлийн хүлээцтэй байдал (Low, Medium, High)
...
\subsection{Сонирхсон хувьцааны жагсаалт}
...
Хэрэгжүүлэлтийн үр дүнг тайлангийн хавсаргалтад оруулав. Дараах функцүүд бүрэн ажиллаж байна:
\begin{itemize}
    \item Хэрэглэгчийн бүртгэл, нэвтрэлт, JWT таниулалт
    \item Сонирхсон хувьцааны жагсаалт үүсгэх, хувьцаа нэмэх/хасах
    \item МХБ хувьцааны AI шинжилгээ (монгол хэлээр)
    \item Хувийн зөвлөмж (хэрэглэгчийн профайлд суурилсан)
    \item Бүртгэлийн AI боловсруулсан мэдэгдэл авах э-мэйл (монгол хэлээр)
    \item Өдөр тутмын мэдээний AI боловсруулсан э-мэйл
