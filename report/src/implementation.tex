...
\begin{itemize}
    ...
    \item Хувийн зөвлөмж: Хэрэглэгчийн профайл (эрсдлийн хүлээцтэй байдал, хөрөнгө оруулалтын зорилго) дээр суурилсан шинжилгээ
...
\begin{itemize}
    ...
    \item Агент бүрийн чадварын тайлбар (төлөвлөгч агентд туслах)
\end{itemize}
...
\textbf{Гол үүргүүд:}
\begin{enumerate}
    \item Гүйцэтгэлийн төлөвлөгөө үүсгэх: Gemini AI эсвэл дүрмэнд суурилсан логик ашиглан олон алхамт төлөвлөгөө боловсруулна
...
\subsection{Амжилттай туршигдсан функцууд}
