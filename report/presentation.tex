...
\begin{frame}{Монолит агентуудын эрсдэл}
    \centering
    \includegraphics[width=0.65\textwidth]{figures/agentMonolith.png}
...
\begin{frame}{Event-Driven агентын систем}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/agentMicroservice.png}
...
\begin{frame}{Бодит хэрэгжүүлсэн архитектур}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/charMicroservice.png}
...
\begin{frame}{Хэрэгжүүлсэн агентууд}
    \footnotesize
    \begin{table}
        \begin{tabular}{p{0.22\textwidth} p{0.73\textwidth}}
            \toprule
            \textbf{Агент} & \textbf{Үүрэг} \\
            \midrule
            Orchestrator & Gemini AI ашиглан хүсэлтүүдийг ангиллаж, агентууд руу даалгавар шилжүүлэх \\
            \midrule
            Knowledge & RAG систем, vector search ашиглан мэдлэг хайх \\
            \midrule
            Investment & МХБ өгөгдөл дүн шинжилж, зөвлөмж өгөх \\
            \midrule
            News & Finnhub API-ээр мэдээ цуглуулж хураангуйлах \\
            \midrule
