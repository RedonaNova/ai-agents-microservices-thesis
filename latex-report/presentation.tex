    ...
    \begin{columns}[t]
        ...
        \begin{block}{AI Engineering}
            \begin{itemize}
                ...
                \item Программ хангамжид интеграци
...
\begin{frame}{Apache Kafka}
    \begin{block}{Үндсэн ойлголтууд}
        \begin{description}[Topic]
            ...
            \item[Producer] Үйл явдал (kafka event) үүсгэгч
            \item[Consumer] Үйл явдал (kafka event) хүлээн авагч
...
\begin{frame}{Apache Flink}
    \begin{block}{Flink-ийн давуу талууд}
        \begin{itemize}
            ...
            \item \textbf{Өндөр дамжуулалт} - Секундэд сая сая үйл явдал (kafka event)
...
\begin{frame}{Архитектурын давуу талууд}
    \begin{block}{Техникийн давуу талууд}
        \begin{itemize}
            \item \textbf{Салангид байдал} - Агентууд бие биеэсээ хараат бус
...
\begin{frame}{Судалгааны үр дүн}
    \begin{block}{Онолын хувьд}
        \begin{itemize}
            \item Хиймэл оюуны инженерчлэл нь программ хангамж хөгжүүлэлтийн шинэ салбар
...
\begin{frame}{Хязгаарлалт ба цаашдын судалгаа}
    \begin{block}{Хязгаарлалтууд}
        \begin{itemize}
            \item Демо систем нь үндсэн фүнцүүдийг агуулсан
            \item Портфолио удирдлага, эрсдэлийн үнэлгээ зэрэг нарийн төвөгтэй функцүүд хараахан хөгжүүлэгдээгүй
        \end{itemize}
    \end{block}
